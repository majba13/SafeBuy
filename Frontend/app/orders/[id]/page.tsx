            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              {order.trackingNumber && (
                <div className="mt-3 pt-3 border-t">
                  <p className="text-xs text-gray-500">Tracking: <strong>{order.trackingNumber}</strong></p>
                  {order.courier && <p className="text-xs text-gray-500">Courier: {order.courier}</p>}
                </div>
              )}
            </div>
